...
citys = ['广东', '浙江', '江苏', '山东', '河北', '河南', '福建', '辽宁', '安徽', '广西', '山西', '海南', '内蒙古',
         '吉林', '黑龙江', '湖北', '湖南', '江西', '宁夏','新疆','青海', '陕西','甘肃',
         '四川', '云南', '贵州', '西藏', '台湾', '香港']
...
class SupplierSpiderSpider(scrapy.Spider):
    ...
    #当前页面>>>第
    start_urls=['https://s.1688.com/company/company_search.htm?keywords=%B8%CA%CB%E0&earseDirect=false&pageSize=30&offset=3&beginPage=78']
